...
constexpr uint16_t MOTOR_CONTROL_LOOP_FREQ = 120;                          //[Hz]
...
constexpr float INITIAL_X_POS = 800.;
constexpr float INITIAL_Y_POS = 200.;
constexpr float INITIAL_ANGLE = M_PI/2;
